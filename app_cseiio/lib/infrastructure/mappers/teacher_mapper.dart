...
import 'package:app_cseiio/infrastructure/models/teacherau/teacher_teachersau.dart';

class TeacherMapper {
  static Teacher teacherAUToEntity(
    TeacherResponseAU teacherAU, {
